        ...
        for peak in peaks:
            ...
            for i in np.arange(len(self.rate)):
                if not backLimitFound: 
                    ...
                    and we only want to include the sharp rise within our boundaries and hence the slope limit is high''' 
            ...
            if len(y) > 1:
                ...
                if r2 > 0.90:
                    ...
                    if len(z) > 1:
                        ...
                        #If it passes the goodness of fit limit again and is sufficiently steep, then we save the peak's parameters
